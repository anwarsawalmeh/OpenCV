...
img = cv2.imread('OpenCV/assets/openCVTutorial.jpeg', 1)
img = cv2.resize(img, (400,400))
cv2.imshow('Image Displaying',img)


""" Wait an infinite amount of time until we click any key on the keyboard. 
    5 Would mean 5 seconds and if not pressed in 5 seconds it's skipped
"""
cv2.waitKey(0)
